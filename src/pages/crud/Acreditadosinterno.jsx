...
export const Acreditadosinterno = () => {
	...
	const [dropdowcategorias, setdropdowcategorias] = useState(null);
	...
	useEffect(() => {
		...
		datatable
			.gettable("parametros/categoriasconvocatoria")
			.then((datos) => setdropdowcategorias(datos));
	}, []);
	...
	// }
	// const descargar = () => {
	// 	datatable.gettable("informes/acreditados").then((datos) => {
	// 		console.log("se deescargo");
	// 	});
	// };
	return (
		<div className='grid'>
					...
					<Dialog
						...
						<TabView>
							<TabPanel
								...
								<div className='col formgrid grid'>
									<div className='field col-6'>
										<label htmlFor='categoriaseleccion'>
											Categoria Proyectos:
										</label>
										<Dropdown
