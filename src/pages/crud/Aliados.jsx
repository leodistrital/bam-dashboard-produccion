					...
					>
						<TabView>
							...
							>
								<div className="formgrid grid">
									<div className="field col">
										...
										<InputText
											id="cat_ali"
											value={formData.cat_ali}
											onChange={(e) => onInputChange(e, "cat_ali")}
											required
											autoFocus
											className={classNames({
												"p-invalid": submitted && !formData.cat_ali,
											})}
										/>
										{submitted && !formData.cat_ali && (
							...
							<TabPanel headerTemplate={tabHeaderIIingles}>
								<div className="field col">
									<label htmlFor="cat_ali_ing">Categoria ingles:</label>
									<InputText
										id="cat_ali_ing"
										value={formData.cat_ali_ing}
										onChange={(e) => onInputChange(e, "cat_ali_ing")}
									/>
								</div>
							</TabPanel>
						</TabView>
